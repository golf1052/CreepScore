...
namespace CreepScore
{
    ...
    public class MatchHistorySummary
    {
        ...
        /// <summary>
        /// Date of match specified as epoch milliseconds
        /// </summary>
        ...
        /// Game mode
        /// </summary>
        public CreepScore.GameMode gameMode;
        ...
        public MatchHistorySummary(int assists, long dateLong, int deaths, long gameId, string gameModeString, bool invalid, int kills, int mapId, int opposingTeamKills, string opposingTeamName, bool win)
        {
            ...
            gameMode = CreepScore.SetGameMode(gameModeString);
            this.invalid = invalid;
            this.kills = kills;
            this.mapId = mapId;
            map = CreepScore.SetMap(mapId);
